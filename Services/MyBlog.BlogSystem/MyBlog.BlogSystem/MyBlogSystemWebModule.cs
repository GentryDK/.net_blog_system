using MyBlog.BlogSystem.Application;
using MyBlog.BlogSystem.Domain.AppSettings;
using MyBlog.BlogSystem.HttpApi.Client;
using Volo.Abp;
...
namespace MyBlog.BlogSystem.web
{
    [DependsOn(
    typeof(AbpAspNetCoreMvcModule),
    typeof(AbpAspNetBearerModule),
    typeof(BlogSystemHttpAPIClientModule),
    typeof(MyBlogSystemApplicationModule),
    typeof(AbpAutofacModule)
           )]
    public class MyBlogSystemWebModule : AbpModule
    {
